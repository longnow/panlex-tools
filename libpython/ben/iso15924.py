...
data_directory = os.path.dirname(__file__) + '/data/iso15924/'
...
def _get_ISO_15924():
    ...
    with open(data_directory + 'iso15924.txt', 'wb') as file:
...
def _initialize_ISO_15924():
    ...
    if os.path.exists(data_directory + 'iso15924.txt'): pass
    else: _get_ISO_15924()
    with open(data_directory + 'iso15924.txt', 'r') as data_file:
